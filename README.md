...
## Test scenes
Four test scenes are provided. The Arcade scene that ships with Falcor, the Breakfast scene and the DragonBuddha scene.  
...
# CONCLUSION
There is still ton of work to be done to have a production ready implementation. Hope i will have some more time to spend on it :) ;)
